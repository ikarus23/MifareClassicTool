...
public class MCReader {
     ...
     * @return The sector that was just checked. On an error condition, it returns
        ...
        if (firstResult != null || secondResult != null) {
            ...
            for (int i = 0; i < length -1 ; i++) {
                if (firstResult != null && firstResult[i] != null
                    ...
                    // None of the results got the data from the block.
                    blocks.add(NO_DATA);
                }
            }
     ...
     * it means that the key A or B (depending on the first dimension) could not
     * be found.
     * @see #getSectorCount()
     * @see #buildNextKeyMapPart()
     */
